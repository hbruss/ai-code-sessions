...
class TestGenerateBatchHtml:
    ...
    def test_handles_failed_session_gracefully(self, output_dir):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            original_generate_html = __import__("ai_code_transcripts").generate_html
            ...
            with patch("ai_code_transcripts.generate_html", side_effect=mock_generate_html):
