"""Tests for HTML generation from session JSON (Claude + Codex adapters)."""
...
class TestRenderContentBlock:
    ...
    def test_tool_result_with_commit(self, snapshot_html):
        ...
        import ai_code_transcripts

        old_repo = ai_code_transcripts._github_repo
        ai_code_transcripts._github_repo = "example/repo"
        try:
            block = {
                "type": "tool_result",
...
class TestOpenOption:
    ...
    def test_session_open_calls_webbrowser(self, output_dir, monkeypatch):
        ...
        monkeypatch.setattr("ai_code_transcripts.webbrowser.open", mock_open)
