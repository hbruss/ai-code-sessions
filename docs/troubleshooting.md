...
- `Codex ran out of room in the model's context window`: the session window is very large. The evaluator retries once with a smaller “budget” digest, but extremely large sessions may still fail.
